...
def main():
    ...
    if "embeddings.index" not in os.listdir("embeddings/"):
    ...
    results = search_docs(user_query, "embeddings/embeddings.index", embedding_model_name, k=10, distance_threshold=0.75)
    ...
    display_page(reranked_results, all_chunks)
